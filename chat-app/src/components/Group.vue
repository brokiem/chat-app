<template>
  <li @click="selectGroup" :class="[isActive ? 'bg-blue-500 text-gray-100' : 'bg-gray-700']" class="select-none hover:text-gray-200 rounded-lg w-12 h-12 flex justify-center items-center hover:bg-blue-500 transition duration-200 cursor-pointer">
